...
public class Medi extends AppCompatActivity {
    ...
    TextView cartchild,totalprice,shownumber;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Medicine"), model.class)
                        .build();
        ...
        reference.child(userid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                {
                    Toast.makeText(Medi.this, "Something wrong", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(Medi.this,Cart.class);
                startActivity(in);
            }
        });
    }
