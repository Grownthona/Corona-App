...
public class Essential_Catagory extends AppCompatActivity {
    ...
    TextView cartchild,totalprice,shownumber,gomed;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_essential__catagory);
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Essential"), model.class)
                        .build();
        ...
        reference.child(userid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                {
                    Toast.makeText(Essential_Catagory.this, "Something wrong", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(Essential_Catagory.this,Cart.class);
                startActivity(in);
            }
        });
        ...
        gomed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(Essential_Catagory.this,Medi.class);
                startActivity(in);
            }
        });
